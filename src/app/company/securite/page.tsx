...
const changePassword = async (data: { currentPassword: string; newPassword: string }) => {
    ...
    const res=await api.put('Companies/ChangeCompanyPassowrd',{
...
export default function Page() {
    ...
    const mutation = useMutation({
        mutationFn: (data: FormData) => changePassword({
    ...
    return (
        <form
            ...
            className="bg-white p-4 flex flex-col gap-3 border-[1px] border-gray-200 rounded-lg w-full"
        >
